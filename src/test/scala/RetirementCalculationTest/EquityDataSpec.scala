...
import org.RetirementCalculation.EquityData
import org.junit.Test
import org.scalatest.Assertions
class EquityDataSpec extends Assertions {
  @Test def loadMarketDataFromTsvFile(): Unit = {
  ...
  @Test def returnAMonthlyDividend(): Unit = {
    assert(EquityData("2016.09", 2157.69, 45.03).monthlyDividend ===(45.03 / 12))
  }
}
